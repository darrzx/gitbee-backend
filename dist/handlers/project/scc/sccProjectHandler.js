...
class SccProjectHandler {
    static getSccDashboard(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const schema = zod_1.z.object({
                    major_id: zod_1.z.string().optional(),
                    semester_id: zod_1.z.string(),
                    is_recommended: zod_1.z.string().optional(),
                ...
                const [reviewedProjects, notReviewedProjects] = yield Promise.all([
                    prisma.project.findMany({
                        where: Object.assign(Object.assign({ projectDetail: Object.assign(Object.assign({ semester_id: params.semester_id }, majorCondition), { status_id: { gte: 3 } }) }, searchCondition), (isRecommendedCondition ? { reviewedProject: isRecommendedCondition } : {})),
                        include: {
                            projectDetail: true,
                            projectGroups: true,
                            galleries: true,
                    ...
                    prisma.project.findMany({
                        where: Object.assign({ projectDetail: Object.assign(Object.assign({ semester_id: params.semester_id }, majorCondition), { status_id: 2 }), assessment: { grade: { gte: 4 } } }, searchCondition),
                        include: {
                            projectDetail: true,
                            projectGroups: true,
                            galleries: true,
...
exports.default = SccProjectHandler;
