...
class ReviewedProjectHandler {
    static getAllReviewedProject(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const reviewedProjects = yield prisma.reviewedProject.findMany({
                    where: {
                        is_recommended: 1
                    },
                    include: {
                ...
                const updatedReviewedProjects = yield Promise.all(reviewedProjects.map((reviewedProject) => __awaiter(this, void 0, void 0, function* () {
                    const { project_id } = reviewedProject, updatedReviewedProjects = __rest(reviewedProject, ["project_id"]);
                    ...
                    return Object.assign(Object.assign({}, updatedReviewedProjects), { project: Object.assign(Object.assign({}, updatedProject), { projectGroups: updatedProjectGroups, galleries: updatedGalleries, projectTechnologies: updatedProjectTechnologies }) });
                })));
                (0, response_1.sendSuccessResponse)(res, updatedReviewedProjects);
            }
            catch (error) {
...
exports.default = ReviewedProjectHandler;
