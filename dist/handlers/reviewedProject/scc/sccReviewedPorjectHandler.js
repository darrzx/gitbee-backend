...
class SccReviewedProjectHandler {
    static insertReviewedProject(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const schema = zod_1.z.object({
                    project_id: zod_1.z.number(),
                    is_recommended: zod_1.z.number(),
                ...
                (0, response_1.sendSuccessResponse)(res, "Project Successfully Reviewed");
            }
            catch (error) {
...
exports.default = SccReviewedProjectHandler;
